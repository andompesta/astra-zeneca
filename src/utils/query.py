from src.utils.common import detokenize
...
class Query:
    ...
    #     except Exception as e:
    #         raise Exception('Cannot find aggregation column {}'.format(
    #             flat['words']))
    ...
    #         except Exception as e:
    #             raise Exception('Missing conditional operator {}'.format(
    #                 flat['words']))
    ...
    #         except Exception as e:
    #             raise Exception('Cannot find conditional column {}'.format(
    #                 col_tokens['words']))
    #         try:
    #             val_index = flat['words'].index('symcond')
    #         except Exception as e:
    #             raise Exception('Cannot find conditional value {}'.format(
    #                 flat['words']))
